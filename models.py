...
def flood_forecasting_model(input_gauge):
    ...
    predicted_result=tm.infer(input_gauge)
    # print(predicted_result)

    # predicted_result_list = predicted_result.tolist()  
    # Convert the ndarray to a list

    # Export predicted_result to a JSON file
    # with open('predicted_result.json', 'w') as json_file:
    #     json.dump({"predicted_result": predicted_result_list}, json_file)
...
# def prediction_result_upload(predicted_result):
